...
function getIndexToIns(arr, num) {
    arr.push(num);                      //add the number to the array
    num = arr.sort(function(a, b){      //sort the array, containing the new number
        return a - b;                   
    }).indexOf(num);                    //find the indexOf the number we added
  return num;
}
